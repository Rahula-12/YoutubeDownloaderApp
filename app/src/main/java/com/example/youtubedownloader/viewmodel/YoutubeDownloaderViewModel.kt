...
class YoutubeDownloaderViewModel(
    private val dao: VideoUrlDao,
    ...
    fun insertUrl(url: String) {
        ...
        val currUrl =
            "https://ytstream-download-youtube-videos.p.rapidapi.com/dl?id=${getYoutubeID(url)}&rapidapi-key=1e59c5254cmsh65f87366aa4844fp138d18jsn4df36025d134"
    ...
    fun outPutVideos(pos: Int) {
        ...
        val queue = Volley.newRequestQueue(context)
        val currUrl =
            "https://ytstream-download-youtube-videos.p.rapidapi.com/dl?id=${getYoutubeID(downloadUrl)}&rapidapi-key=1e59c5254cmsh65f87366aa4844fp138d18jsn4df36025d134"
        val jsonObjectRequest = JsonObjectRequest(
...
class YoutubeDownloaderViewModelFactory(private val dao: VideoUrlDao, private val context: Context) :
